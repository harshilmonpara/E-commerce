...
function submit() {
    ...
    if (document.getElementById('password').value == '' && document.getElementById('number').value == '') {
...
function login() {
    ...
    for (let i = 0; i < alldata.length; i++) {
        if (document.getElementById('uname01').value == alldata[i].uname && document.getElementById('pass01').value == alldata[i].password) {
            see = true
        }
        else {
